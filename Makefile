...
GCC_LIB32      :=      $(shell dirname $(shell gcc -m32 -print-libgcc-file-name 2>/dev/null || echo /usr/lib/gcc/x86_64-linux-gnu/14/32))

#       Kernel  Flags
CFLAGS  =       -m32    -fno-stack-protector    -fno-builtin    -nostdinc       -O2     -Iinclude       -Icore  -Ihal/drivers   -Ihal/cpu       -Icommon        -Isys   -Ifs    -Iusr   -Ikernel        -Ilib   -Imujs-1.3.9    -fno-pic        -fno-pie        -mno-sse        -mno-mmx        -g      -Wall   -Wno-unused-parameter   -MMD    -MP     -DKERNEL_MODE
