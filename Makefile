...
#       Kernel  Flags
CFLAGS  =       -m32    -fno-stack-protector    -fno-builtin    -nostdinc       -O2     -Iinclude       -Icore  -Ihal/drivers   -Ihal/cpu       -Icommon        -Isys   -Ifs    -Iusr   -Ikernel        -Ilib   -Imujs-1.3.9    -fno-pic        -fno-pie        -mno-sse        -mno-mmx        -g      -Wall   -Wno-unused-parameter   -DKERNEL_MODE
