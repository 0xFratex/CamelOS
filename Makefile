...
USR_SRC =       usr/shell.c     usr/bubbleview.c        usr/desktop.c   usr/framework.c usr/dock.c      usr/clipboard.c usr/screenlock.c        usr/welcome_setup.c     usr/lib/camel_framework.c       usr/lib/camel_ui.c      usr/apps/files.c        usr/apps/terminal.c     usr/apps/textedit.c     usr/apps/settings.c    usr/apps/browser.c     usr/apps/mactest.c     usr/libs/browser_dom.c
